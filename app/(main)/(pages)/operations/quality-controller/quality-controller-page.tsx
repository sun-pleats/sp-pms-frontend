...
const QualityControllerPage = () => {
  ...
  return (
    <>
      <PageTile title="Quality Controller" icon="pi pi-fw pi-cog" url={ROUTES.PRODUCTION_OPERATION.INDEX} />
      <PageHeader
        titles={['Operations', 'Quality Controller', ` Quality Controller Process for ${moment(trackFilter.date).format('Y MMMM D')}`]}
      ></PageHeader>
...
export default QualityControllerPage;
