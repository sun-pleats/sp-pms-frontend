        ...
        <div className="flex flex-align-items-center">
          <div className="flex flex-align-items-center mr-2">
            <div className="flex align-items-center gap-2">
              ...
              />
              <Button tooltip="Back to home" icon="pi pi-home" className="mt-2" outlined rounded onClick={() => router.push('/')}></Button>
              <Button
                tooltip="Go to Kiosk"
                label="Kiosk"
                icon="pi pi-desktop"
...
export default SectionMonitorPage;
